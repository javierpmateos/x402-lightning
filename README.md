...
Reference facilitator for the x402 `exact` scheme on Bitcoin Lightning: Bitcoin Lightning as a
...
- Spec draft: `specs/scheme_exact_lightning.md` (target: x402-foundation/x402 `specs/schemes/`)
- Stateless verification: checks 1-6 are pure; only replay protection (check 7) holds state
